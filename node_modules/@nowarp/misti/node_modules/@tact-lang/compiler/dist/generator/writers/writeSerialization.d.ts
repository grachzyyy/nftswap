...
export declare function writeParser(type: TypeDescription, name: string, forceInline: boolean, opcode: "with-opcode" | "no-opcode", allocation: StorageAllocation, ctx: WriterContext): void;
