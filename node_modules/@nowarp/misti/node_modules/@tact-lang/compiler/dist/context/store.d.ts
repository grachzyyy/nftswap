...
export type AstStore = {
    ...
    functions: (Ast.FunctionDef | Ast.NativeFunctionDecl | Ast.AsmFunctionDef)[];
 ...
 * @public
 */
export declare function parseModules(sources: Source[], parser: Parser): Ast.Module[];
/**
...
export declare function openContext(ctx: CompilerContext, sources: Source[], funcSources: {
    code: string;
    path: string;
}[], parser: Parser, parsedModules?: Ast.Module[]): CompilerContext;
