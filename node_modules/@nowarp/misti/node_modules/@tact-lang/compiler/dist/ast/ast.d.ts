...
export type ModuleItem = PrimitiveTypeDecl | FunctionDef | AsmFunctionDef | NativeFunctionDecl | ConstantDef | StructDecl | MessageDecl | Contract | Trait;
export type TypeDecl = PrimitiveTypeDecl | StructDecl | MessageDecl | Contract | Trait;
...
export type ContractDeclaration = FieldDecl | FunctionDef | AsmFunctionDef | ContractInit | Receiver | ConstantDef;
export type TraitDeclaration = FieldDecl | FunctionDef | AsmFunctionDef | FunctionDecl | Receiver | ConstantDef | ConstantDecl;
...
export type Statement = StatementLet | StatementReturn | StatementExpression | StatementAssign | StatementAugmentedAssign | StatementCondition | StatementWhile | StatementUntil | StatementRepeat | StatementTry | StatementForEach | StatementDestruct | StatementBlock;
...
export type Expression = OpBinary | OpUnary | Conditional | MethodCall | FieldAccess | StaticCall | StructInstance | Id | InitOf | CodeOf | String | Literal;
export type Literal = Number | Boolean | Null | SimplifiedString | Address | Cell | Slice | StructValue;
...
export type FunctionAttributeName = "mutates" | "extends" | "virtual" | "abstract" | "override" | "inline";
...
export type ReceiverSubKind = ReceiverSimple | ReceiverFallback | ReceiverComment;
...
export type AstNode = FuncId | Wildcard | DestructMapping | DestructEnd | Expression | Statement | TypeDecl | FieldDecl | TypedParameter | FunctionDef | FunctionAttribute | AsmFunctionDef | FunctionDecl | Module | NativeFunctionDecl | StructFieldInitializer | StructFieldValue | Type | ContractInit | Receiver | Import | ConstantDef | ConstantDecl | ReceiverKind | ReceiverSubKind;
