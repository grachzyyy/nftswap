...
function checkParameterType(expression, parameter, ctx) {
    ...
    if (!(0, subtyping_1.isAssignable)(t, parameter.type)) {
        ...
        (0, errors_1.throwCompilationError)(`Cannot pass an expression of type "${(0, types_1.printTypeRef)(t)}" to the parameter ${(0, errors_1.idTextErr)(name)} of type "${(0, types_1.printTypeRef)(parameter.type)}"`, expression.loc);
    }
}
