    ...
    switch (type.kind) {
        ...
        case "map_type": {
            ...
            return {
                kind: "map",
                key: keyTy.name,
                keyAs: type.keyStorageType !== undefined
                    ? (0, ast_helpers_1.idText)(type.keyStorageType)
                    : null,
                value: valTy.name,
                valueAs: type.valueStorageType !== undefined
...
function resolveDescriptors(ctx, Ast) {
    ...
    function buildFieldDescription(src, index) {
        ...
        return {
            ...
            type: fieldTy,
            index,
            as: src.as !== undefined ? (0, ast_helpers_1.idText)(src.as) : null,
    ...
    function resolveFunctionDescriptor(optSelf, a, origin) {
        ...
        if (isExtends) {
            ...
            parameterNameSet.add((0, ast_helpers_1.idText)(firstParam.name));
        ...
        for (const param of params) {
            ...
            parameterNameSet.add((0, ast_helpers_1.idText)(param.name));
        }
            ...
            if (a.shuffle.args.length !== 0) {
                ...
                for (const typedId of a.params) {
                    if (typedId.name.kind === "wildcard") {
                        (0, errors_1.throwCompilationError)("cannot use wildcards with argument rearrangement", a.loc);
                    }
                    paramsArray.push((0, ast_helpers_1.idText)(typedId.name));
                }
...
function checkConstantsAndDefaultContractAndStructFields(ctx) {
