...
class DumpImports extends tool_1.Tool {
    ...
    runWithCU(cu) {
        switch (this.options.format) {
            case "dot":
                return this.makeOutput(cu, GraphvizDumper.dumpImportGraph(cu.imports, this.options.dumpStdlib));
            case "mmd":
                return this.makeOutput(cu, MermaidDumper.dumpImportGraph(cu.imports, this.options.dumpStdlib));
            case "json":
                return this.makeOutput(cu, JSONDumper.dumpImportGraph(cu.imports, this.options.dumpStdlib));
            default:
...
exports.DumpImports = DumpImports;
/**
...
class MermaidDumper {
     ...
     */
    static dumpImportGraph(ig, dumpStdlib) {
        ...
        ig.edges.forEach((edge) => {
            ...
            // Optionally exclude stdlib nodes
            if ((!dumpStdlib && srcNode.origin === "stdlib") ||
...
class JSONDumper {
    ...
    static dumpImportGraph(ig, dumpStdlib) {
        const nodes = ig.nodes
            ...
            name: node.name,
            origin: node.origin,
            importPath: path_1.default.relative(process.cwd(), node.importPath),
