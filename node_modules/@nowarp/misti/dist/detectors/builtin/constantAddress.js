...
exports.ConstantAddress = void 0;
 ...
 * ```
 */
class ConstantAddress extends detector_1.AstDetector {
    ...
    findConstantAddress(acc, expr) {
        if (expr.kind === "static_call") {
            if (expr.function.text === "address" &&
                expr.args.length === 1 &&
                expr.args[0].kind === "string") {
                acc.push(this.makeWarning("Found constant address", expr.loc, {
                    extraDescription: "Using hardcoded addresses can sometimes indicate poor contract design",
                }));
            }
        }
        return acc;
...
exports.ConstantAddress = ConstantAddress;
